  ...
  const [companies, setCompanies] = useState<CompanyIntel[]>([
    {
      ...
      recentFunding: "₹5,400 Cr Series I (Valuation: ₹5.4 Lakh Cr)",
      headcountGrowth: "+18% YoY",
      location: "San Francisco, CA / Dublin",
      hrContact: "Priya Sharma (Head of Talent)",
      timeline: [
        { date: "May 12", event: "Funding announced (₹5,400 Cr for regional expansion)", icon: DollarSign, status: "completed" },
    ...
    },
    {
      ...
      recentFunding: "₹3,750 Cr Venture Loan (Growth Phase)",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="border border-slate-800 bg-slate-900 p-5 rounded-2xl flex items-center justify-between">
              <div>
                ...
                <div className="text-2xl font-black text-white mt-1">₹3.75 Cr</div>
                <div className="text-xs text-amber-400 mt-1 flex items-center gap-1">
                  <span className="font-bold text-[10px]">₹</span> Dynamic Forecast Value
                </div>
              </div>
              <span className="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-400 flex items-center justify-center w-11 h-11">
              ...
              <div className="space-y-4">
                <div className="border border-indigo-500/10 bg-indigo-500/5 p-4 rounded-xl relative overflow-hidden">
                  ...
                  <p className="text-[11px] text-slate-400 mt-1 leading-relaxed">
                    Stripe hiring velocity scored 94/100 following their ₹5,400 Cr funding announcement. <strong>Rahul Sharma</strong> matches 98% based on professional bench profile.
                  </p>
                  <button
                    onClick={() => {
                      const stripeCompany = companies.find(c => c.id === "stripe");
        ...
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="border border-slate-800 bg-slate-900 p-5 rounded-2xl">
              ...
              <div className="text-3xl font-black text-white mt-1">₹12.4 Cr</div>
            ...
            <div className="border border-slate-800 bg-slate-900 p-5 rounded-2xl">
              ...
              <div className="text-3xl font-black text-white mt-1">₹35,50,000</div>
            ...
            <div className="border border-slate-800 bg-slate-900 p-5 rounded-2xl">
              ...
              <div className="text-3xl font-black text-white mt-1">₹1,05,000</div>
