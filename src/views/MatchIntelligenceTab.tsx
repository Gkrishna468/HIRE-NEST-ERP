...
export default function MatchIntelligenceTab() {
  ...
  const [skillVerificationModal, setSkillVerificationModal] = useState<{ match: any, cand: any, criterion: string } | null>(null);
  const [verificationForm, setVerificationForm] = useState({ years: "", project: "", company: "", details: "" });
  ...
  const handleOpenVerificationModal = (match: any, cand: any, criterionName: string) => {
  ...
  const handleVerifyAndEnhanceResume = async () => {
    ...
    const evidenceNotes = `${verificationForm.years} years at ${verificationForm.company} (${verificationForm.project}). ${verificationForm.details}`;
                                                                ...
                                                                {currentMatrixState.matrix.filter((item: any) => item.result === "VALIDATE" || item.result === "GAP").map((item: any, i: number) => (
                                                                  <div key={i} className="py-2.5 flex justify-between items-center">
                                                                    ...
                                                                    <button
                                                                      ...
                                                                      onClick={() => handleOpenVerificationModal(match, cand, item.criterion)}
